...
def train_test_split(src_folder, train_size = 0.8):
	# Making sure we remove any existing folders and start from a clean slate
	...
	# Creating new empty train and test folders
	...
	# Geting the number of cats and dogs images
	...
	# Randomly assigning images to train and test
	...
	# removing corrupted exif data from the dataset
