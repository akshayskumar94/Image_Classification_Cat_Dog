...
# Checking if the dataset has been downloaded.
...
# creating the train/test folders if it does not exists already
...
# Adding a fully connected layer with 1 node at the end 
input_ = vgg16.input
